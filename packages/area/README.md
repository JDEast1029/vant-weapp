...
```json
"usingComponents": {
  "mc-area": "path/to/@vant/weapp/dist/area/index"
}
```
...
```html
<mc-area area-list="{{ areaList }}" value="110101" />
```
...
```html
<mc-area area-list="{{ areaList }}" columns-num="{{ 2 }}" title="标题" />
```
